...
#
# Script generated by Vivado on Mon Jun 15 18:05:21 -0400 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/TIDIAC/summer2025_research_tiadc/axi_lite_wrapper/ip_repo/edit_axi_lite_wrapper_v1_0.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
