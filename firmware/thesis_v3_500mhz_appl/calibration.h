...
#define CALIBRATION_OFFSET_MIN_CONFIRMATION_BATCHES    4U
#define CALIBRATION_OFFSET_BATCH_SIZE                  30U
#define CALIBRATION_OFFSET_UPDATE_STEP                 0.50f
#define CALIBRATION_OFFSET_NEAR_UPDATE_STEP            0.35f
#define CALIBRATION_OFFSET_NEAR_RESIDUAL_CODES         5.0f
#define CALIBRATION_OFFSET_FILTER_ALPHA                0.60f
...
#define CALIBRATION_OFFSET_MAX_CONTROLLER_STEP_CODES   1.5f
#define CALIBRATION_OFFSET_CONVERGENCE_RAW_LIMIT_CODES 2.0f
#define CALIBRATION_OFFSET_CONVERGENCE_MAX_UNCERTAINTY_CODES 1.0f
...
#define CALIBRATION_OFFSET_VERIFICATION_UNCERTAINTY_SIGMA 2.0f
#define CALIBRATION_OFFSET_VERIFICATION_MAX_UNCERTAINTY_CODES 1.0f
